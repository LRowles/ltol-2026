...
const TermsOfService = () => {
  useSEO({
    title: "Terms of Service | LTOL",
    description: "LTOL terms of service. Review the terms and conditions governing your use of our services.",
    path: "/terms",
    noindex: true,
  });
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        ...
        <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
          ...
          <p>Questions about these terms can be directed to <a href="mailto:support@ltol.com" className="text-primary underline">support@ltol.com</a>.</p>
        </div>
      </main>
      <Footer />
    </div>
