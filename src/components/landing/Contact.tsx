...
const contactInfo = [
  {
    ...
    label: "Phone",
    value: "(775) 555-LTOL",
    href: "tel:+17755555865",
  },
  {
    icon: Mail,
    label: "Email",
    value: "hello@ltol.com",
    href: "mailto:hello@ltol.com",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Lake Tahoe • Reno • Western US",
    href: null,
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Tell us about your business and technology needs..."
                      rows={4}
                  ...
                  >
                    {isSubmitting ? "Sending..." : (
                      <>Schedule a Consultation <Send className="ml-2 w-5 h-5" /></>
                    )}
                  </Button>
                </form>
              )}
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-muted-foreground mb-8">
              Have questions? We're here to help. Real people, real answers — that's the LTOL way.
            </p>
            ...
            <div className="mt-8 p-6 rounded-2xl bg-muted/50 border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                We respond to all inquiries within 24 hours. For urgent IT issues, call us directly — 
