...
export const assessments: AssessmentData[] = [
  {
    ...
    bands: [
      { min: 0, max: 5, label: "Early Stage", description: "Your business has significant opportunities for AI, but some foundational systems need to be in place first. We recommend starting with CRM and workflow documentation before AI adoption.", cta: "Get a Free Strategy Session" },
      { min: 6, max: 11, label: "Emerging Opportunity", description: "You have a solid foundation for AI adoption. There are clear opportunities to automate workflows, improve follow-up, and enhance customer experience with AI tools.", cta: "Get a Free Strategy Session" },
      { min: 12, max: 16, label: "Strong AI Readiness", description: "Your business is well-positioned for AI integration. You have the systems, data, and team readiness to achieve significant results from strategic AI adoption.", cta: "Get a Free Strategy Session" },
    ],
  ...
  },
  {
    ...
    bands: [
      { min: 0, max: 5, label: "Foundation Needed", description: "Your technology stack has significant gaps that are likely impacting your efficiency and growth. Building a connected foundation should be a priority.", cta: "Get a Free Strategy Session" },
      { min: 6, max: 11, label: "Growing but Disconnected", description: "You have several tools in place but they may not be working together effectively. Connecting and optimizing your existing stack could deliver significant improvements.", cta: "Get a Free Strategy Session" },
      { min: 12, max: 16, label: "Well-Equipped", description: "Your technology stack is solid. Focus on optimization, advanced automation, and AI integration to maximize your investment.", cta: "Get a Free Strategy Session" },
    ],
  ...
  },
  {
    ...
    bands: [
      { min: 0, max: 4, label: "High Risk", description: "Your business has significant cybersecurity vulnerabilities that need immediate attention. You're at elevated risk for data breaches, ransomware, and other cyber threats.", cta: "Get a Free Security Assessment" },
      { min: 5, max: 9, label: "Moderate Risk", description: "You have some protections in place but there are notable gaps. Strengthening your security fundamentals would significantly reduce your risk exposure.", cta: "Get a Free Security Assessment" },
      { min: 10, max: 14, label: "Well-Protected", description: "Your security posture is solid. Focus on advanced protections, regular testing, and employee training to maintain and improve your defenses.", cta: "Get a Free Security Assessment" },
    ],
  ...
  },
  {
    ...
    bands: [
      { min: 0, max: 4, label: "Marketing Gap", description: "Your marketing systems have significant gaps that are likely costing you leads and revenue. Building connected infrastructure should be a priority.", cta: "Get a Free Strategy Session" },
      { min: 5, max: 8, label: "Partially Connected", description: "You have some marketing tools but they're not working together effectively. Connecting and automating your systems could significantly improve your lead conversion.", cta: "Get a Free Strategy Session" },
      { min: 9, max: 12, label: "Marketing Machine", description: "Your marketing systems are well-built. Focus on advanced automation, AI-powered optimization, and expanding your content strategy.", cta: "Get a Free Strategy Session" },
    ],
